...
#define ALBB_SESSION_SDK_VERSION  @"1.0.0"
...
-(void) initSession:(initSessionSuccessCallback) successCallback failureCallback:(initSessionSuccessCallback) failedCallback;
