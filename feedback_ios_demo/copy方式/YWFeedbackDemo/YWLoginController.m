...
- (IBAction)actionScanCode:(id)sender {
    ...
    vc.readFinishedBlock = ^(NSString *text){
        [weakVC dismissViewControllerAnimated:YES completion:^{
            ...
            YWFeedbackViewController *webVC = [[YWFeedbackViewController alloc] initWithFeedbackKit:nil extInfo:nil configration:configration];
            __weak typeof(webVC) weakWebVC = webVC;
            webVC.closeBlock = ^(YWFeedbackViewController *feedbackController){
                [weakWebVC dismissViewControllerAnimated:YES completion:nil];
            };
            [webVC view];
